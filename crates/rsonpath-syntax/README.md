...
![MSRV](https://img.shields.io/badge/msrv-v1.71.0-orange?logo=rust "Minimum Supported Rust Version for `rsonpath-syntax`")
[![License](https://img.shields.io/crates/l/rsonpath-syntax)](https://choosealicense.com/licenses/mit/)
